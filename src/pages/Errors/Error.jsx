...
const ErrorPage = () => {
  return (
    <div className="bg-black h-screen flex flex-col justify-center items-center">
      ...
      <Link
        to="/"
        className="w-full md:w-auto px-6 py-2 bg-black text-white font-semibold rounded-md hover:bg-white hover:text-black transition-colors border-2 border-dotted border-gray-500 mt-8"
      >
        Back to Home
      </Link>
    </div>
