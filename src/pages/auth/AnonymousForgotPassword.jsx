    ...
    const onSubmit = async (data, event) => {
      ...
      try {
        ...
        toast.success("User found");
          setTimeout(() => window.location.href = '/anonymous-forgot-password-question', 200); // Adding a slight delay
  ...
  return (
    <div className='text-center h-screen py-24 bg-black text-white mx-auto'>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <input type="text" id="anonymous-forgot-password" 
...
export default AnonymousForgotPassword
