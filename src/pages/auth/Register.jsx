...
const Register = () => {
  ...
  const schema = yup.object().shape({
    username: role === "anonymous" 
      ? yup.string().required("Username is required").min(4, "Username must be at least 4 characters")
      : yup.string(),
  
    first_name: role === "counselor" 
      ? yup.string().required("First name is required").min(2, "First name must be at least 2 characters")
      : yup.string(),
  
    last_name: role === "counselor" 
      ? yup.string().required("Last name is required").min(2, "Last name must be at least 2 characters")
      : yup.string(),
  
    image: role === "counselor" 
      ? yup.mixed().required("Profile image is required")
      : yup.mixed(),
  
    counseling_field: role === "counselor" 
      ? yup.string().required("Counseling field is required")
      : yup.string(),
    ...
    bio: role === "counselor" 
      ? yup.string().required("Bio is required").min(10, "Bio must be at least 10 characters")
      : yup.string(),
