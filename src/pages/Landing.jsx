...
<div className="flex justify-center items-center text-white h-40">
  ...
  <Link to="/choose-register-role" className="w-full md:w-auto px-6 py-2 bg-white text-black font-semibold rounded-md hover:bg-black hover:text-white hover:border-2 transition-colors mr-2">
    Get Started
  </Link>
  <Link to="/choose-login-role" className="w-full md:w-auto px-6 py-2 bg-black text-white font-semibold rounded-md hover:bg-white hover:text-black transition-colors border-2 border-dotted border-gray-500 ml-2">
    Login
  </Link>
</div>
