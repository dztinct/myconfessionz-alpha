...
const HomeRightSideBar = () => {
  return (
    <div>
      <div className="flex flex-col h-full px-8 w-60 dark:bg-gray-50 dark:text-gray-800 mt-20 hidden md:block font-semibold">
	<div className="space-y-3">
		<div className="flex items-center justify-between">
			<h2>Search Counselors <br />By Field</h2>
		</div>
		<div className="relative">
			...
			<input type="search" name="search" placeholder="Search..." className="w-full py-2 pl-10 text-sm dark:border- rounded-md focus:outline-none dark:bg-gray-100 dark:text-gray-800 focus:dark:bg-gray-50 border-2" />
		</div>
